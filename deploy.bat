...
class Deploy
{
	static void Main()
	{
		...
		List<string> files = new List<string>()
		{
			...
			"./src/MSR.Models/bin/Release/MSR.Models.dll",
			"./src/MSR.Models/bin/Release/MSR.Models.pdb",
			...
			"./src/MSR.Tools.Predictor/bin/Release/MSR.Tools.Predictor.exe",
			"./src/MSR.Tools.Predictor/bin/Release/MSR.Tools.Predictor.pdb",
			"./src/MSR.Tools.Visualizer/bin/Release/MSR.Tools.Visualizer.exe",
